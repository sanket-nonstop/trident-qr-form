...
export default function InductionPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      console.log("[Induction] Submitting form", {
      ...
      console.log("[Induction] API response", {
      ...
      if (response.ok) {
        setMessage({
          type: "success",
          text: "Thank you! Your induction has been recorded.",
        });
        setFirstName("");
        setLastName("");
        setEmail("");
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <header className="text-center mb-12 md:mb-20 animate-fade-in text-white">
          ...
          <p className="text-slate-200 text-lg md:text-xl max-w-2xl mx-auto font-medium leading-relaxed tracking-wide">
            Please complete the safety induction video and form below before
            entering the site.
          </p>
        </header>
          ...
          >
            <div className="relative glass-card rounded-[1rem] overflow-hidden group border-primary/20">
              ...
              <div className="p-5 bg-black/50 backdrop-blur-md flex items-center justify-between border-b border-primary/20">
                <div className="flex items-center gap-3 text-white">
                  <span className="text-sm md:text-lg font-black text-slate-100 uppercase tracking-[0.2em] ml-0 md:ml-2 font-mono">
                    Safety Induction
                  </span>
                </div>
            ...
            <div className="hidden lg:grid grid-cols-2 gap-6">
              {[
                {
                  title: "PPE Readiness",
                  desc: "Ensure all personal protective equipment is verified.",
                  icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
                },
                {
                  title: "Safety Protocol",
                  desc: "Strict adherence to site-specific protocols is required.",
                  icon: "M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z",
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="p-8 glass-card rounded-[2.5rem] group hover:border-primary/40 transition-all border-primary/10"
                >
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  <div className="space-y-6">
                    <div className="relative group">
                      <label
                        htmlFor="firstName"
                        className="block text-[11px] font-medium text-slate-300 uppercase tracking-[0.3em] mb-3 group-focus-within:text-primary transition-colors"
                      >
                        First Name
                      </label>
                      <input
                      ...
                      {showValidation && firstName.trim().length === 0 && (
                        <p className="mt-2 text-rose-500 text-xs font-bold uppercase tracking-wider animate-fade-in">
                  ...
                  <div className="space-y-5 bg-black/60 p-6 rounded-[1.5rem] border border-primary/20">
                    <label className="flex items-start gap-4 cursor-pointer group">
                      <div className="relative flex-shrink-0 mt-0.5">
                        ...
                        />
                        <svg
                          className="absolute top-1 left-1 w-3 h-3 text-slate-950 opacity-0 peer-checked:opacity-100 transition-opacity pointer-events-none"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                      ...
                      <span className="text-sm font-medium text-slate-100 group-hover:text-white transition-colors leading-relaxed">
                        I have watched the Trident Group induction and safety
                        video.
                      </span>
                    </label>
                    ...
                    <label className="flex items-start gap-4 cursor-pointer group">
                      ...
                      <span className="text-sm font-medium text-slate-100 group-hover:text-white transition-colors leading-relaxed">
                        I will follow all safety measures indicated while on
                        site.
                      </span>
                    </label>
                  </div>
                    ...
                    <div className="p-4 rounded-xl bg-rose-500/10 border border-rose-500/20 animate-fade-in">
                      {!videoWatched && (
                        <p className="text-rose-500 text-xs font-bold uppercase tracking-wider mb-1">
                          Please watch the safety induction video
                        </p>
                      )}
                      {!agreeSaftey && (
                        <p className="text-rose-500 text-xs font-bold uppercase tracking-wider">
                          Please agree to safety measures
                        </p>
                      )}
                    </div>
                  )}
                  ...
                  {showValidation && !captchaToken && (
                    <p className="text-rose-500 text-xs font-bold uppercase tracking-wider text-center animate-fade-in">
                  ...
                  {message && (
                    <div
                      className={`p-5 rounded-2xl text-sm font-bold animate-fade-in border ${message.type === "success"
                  ...
                  <div className="space-y-4">
                    <button
                      ...
                      className={`gold-button w-full py-4 md:py-5 rounded-2xl border border-primary/40 text-[13px] sm:text-sm md:text-base lg:text-lg transition-all ${!isFormValid
...
//                   poster="/poster.jpg"
//                   onEnded={() => setHasCompletedVideo(true)}
//                 >
//                   <source src="mandatory-video.mp4" type="video/mp4" />
//                 </video>
//               </div>
...
//                           className="peer appearance-none w-5 h-5 rounded-md border-2 border-primary/40 bg-slate-900 appearance-none checked:bg-primary checked:border-primary transition-all cursor-pointer shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
//                         />
...
//                         Please watch the full video to enable this checkbox.
//                       </p>
//                     )}

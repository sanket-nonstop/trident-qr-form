      ...
      <div className="max-w-7xl mx-auto">
        ...
        <header className="text-center mb-12 md:mb-20 animate-fade-in text-white">
          <div className="relative inline-flex items-center justify-center p-1 mb-8 group">
            <div className="absolute inset-0 bg-primary/20 blur-[60px] rounded-full transition-all duration-1000 group-hover:bg-primary/30"></div>
            <div className="relative h-24 w-24 flex items-center justify-center rounded-[2.5rem] bg-[#0f172a]/80 border border-primary/20 backdrop-blur-xl shadow-2xl overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-7 space-y-8 animate-fade-in" style={{ animationDelay: '0.1s' }}>
            <div className="relative glass-card rounded-[1rem] overflow-hidden group">
              <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-transparent pointer-events-none"></div>

              <div className="p-5 bg-black/40 backdrop-blur-md flex items-center justify-between border-b border-primary/10">
                <div className="flex items-center gap-3 text-white">
                  ...
                  <span className="text-[10px] font-bold text-slate-300 uppercase tracking-[0.2em] ml-2 font-mono">Safety Induction</span>
                </div>
                <div className="px-3 py-1 rounded-full bg-primary/5 border border-primary/20">
                  <span className="text-[10px] font-bold text-primary uppercase tracking-widest">Mandatory</span>
                </div>
              </div>
            ...
            <div className="hidden lg:grid grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="p-8 glass-card rounded-[2.5rem] group hover:border-primary/30 transition-all">
          ...
          <div className="lg:col-span-5 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <div className="glass-card rounded-[1rem] shadow-2xl relative overflow-hidden backdrop-blur-2xl border-primary/20">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  <div className="space-y-6">
                    <div className="relative group">
                      <label htmlFor="firstName" className="block text-[10px] font-bold text-slate-300 uppercase tracking-[0.3em] mb-3 group-focus-within:text-primary transition-colors">First Name</label>
                      <input
                        id="firstName"
                        type="text"
                        required
                    ...
                    <div className="relative group">
                      <label htmlFor="lastName" className="block text-[10px] font-bold text-slate-300 uppercase tracking-[0.3em] mb-3 group-focus-within:text-primary transition-colors">Last Name</label>
                      <input
                        id="lastName"
                        type="text"
                        required
                    ...
                    <div className="relative group">
                      <label htmlFor="email" className="block text-[10px] font-bold text-slate-300 uppercase tracking-[0.3em] mb-3 group-focus-within:text-primary transition-colors">Email Address</label>
                      <input
                        id="email"
                        type="email"
                        required
                  ...
                  <div className="space-y-5 bg-black/60 p-6 rounded-[2rem] border border-primary/10">
                    <label className="flex items-start gap-4 cursor-pointer group">
                      <div className="relative flex-shrink-0 mt-0.5">
                        <input
                          ...
                          className="peer appearance-none w-6 h-6 rounded-lg border-2 border-primary/30 bg-slate-900 appearance-none checked:bg-primary checked:border-primary transition-all cursor-pointer shadow-lg"
                        />
                  ...
                  */}
                  ...
                  <button
                    ...
                    className="gold-button w-full py-5 rounded-2xl border border-primary/10"
                  >
                    {isSubmitting ? (
                      ...
                      <span className="flex items-center justify-center gap-3 uppercase font-black text-amber-50">
                        Complete Induction
                  ...
                  {!isFormValid && !isSubmitting && (
                    <p className="text-center text-[10px] font-black text-slate-400 uppercase tracking-[0.4em] animate-pulse">
              ...
              <div className="px-10 py-5 bg-black/40 border-t border-primary/20 text-center">
